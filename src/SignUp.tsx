    ...
    <div className="min-h-screen bg-gradient-to-br from-[#E5E0D8] via-[#E5D2B8] to-[#D2AB80] flex items-center justify-center p-6">
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[#725C3A]/70 text-lg">Join thousands of parents today</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-xs text-[#725C3A]/50 mb-3">Trusted by parents worldwide</p>
          <div className="flex justify-center items-center gap-4 text-xs text-[#725C3A]/60">
            <span>🔒 Encrypted</span>
            <span>•</span>
